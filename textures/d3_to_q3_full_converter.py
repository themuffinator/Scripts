"""Backward compatible CLI for Doom 3 -> Quake 3 conversion."""
...
DEFAULT_PROFILE = "doom3"


def main(argv: list[str] | None = None) -> int:
    """Invoke the unified converter, defaulting to the Doom 3 profile.

    Legacy scripts invoked this module directly with ``--config``.  We honour
    that contract while forwarding into the shared implementation.
    """
